;(function (factory) {
  ...
  function createScrollSnap(element, settings, callback) {
    ...
    var animationFrame
    var snapDestinationX = settings.snapDestinationX,
      snapDestinationY = settings.snapDestinationY
    if (
      snapDestinationX &&
      ...
      throw new Error(
        "Settings property 'snapDestinationX' is not valid, expected STRING or NUMBER but found " +
          (typeof snapDestinationX).toUpperCase()
      )
    }
    if (
      snapDestinationY &&
      ...
      throw new Error(
        "Settings property 'snapDestinationY' is not valid, expected STRING or NUMBER but found " +
          (typeof snapDestinationY).toUpperCase()
      )
    }
    if (
      settings.timeout &&
      ...
      throw new Error(
        "Optional settings property 'timeout' is not valid, expected NUMBER but found " +
          (typeof settings.timeout).toUpperCase()
      )
    }
    ...
    if (
      ...
      throw new Error(
        "Optional settings property 'duration' is not valid, expected NUMBER but found " +
          (typeof settings.duration).toUpperCase()
      )
    }
    ...
    if (
      ...
      throw new Error(
        "Optional settings property 'threshold' is not valid, expected NUMBER but found " +
          (typeof settings.threshold).toUpperCase()
      )
    }
    var threshold = settings.threshold || THRESHOLD_DEFAULT
    if (settings.easing && typeof settings.easing !== "function") {
      throw new Error(
        "Optional settings property 'easing' is not valid, expected FUNCTION but found " +
          (typeof settings.easing).toUpperCase()
      )
    }
    var easing = settings.easing || EASING_DEFAULT
    if (settings.snapStop && typeof settings.snapStop !== "boolean") {
      throw new Error(
        "Optional settings property 'snapStop' is not valid, expected BOOLEAN but found " +
          (typeof settings.snapStop).toUpperCase()
      )
    }
